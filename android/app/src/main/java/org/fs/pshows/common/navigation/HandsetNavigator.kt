...
package org.fs.pshows.common.navigation
...
@Singleton
class HandsetNavigator @Inject constructor(): Navigator<Show> {

  override fun navigate(activity: AbstractActivity<*, *>, data: Show) = activity.resolveActivity(DetailActivity::class.java, Bundle().apply {
    putParcelable(BUNDLE_EXTRA_SHOW, data)
  })
}