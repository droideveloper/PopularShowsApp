...
import org.fs.pshows.view.*

@Module
abstract class ActivityModule {

  @ForActivity @Binds abstract fun bindLandingActivityView(activity: LandingActivity):  LandingActivityView
  @ForActivity @Binds abstract fun bindMainActivityView(activity: MainActivity): MainActivityView
  @ForActivity @Binds abstract fun bindDetailActivityView(activity: DetailActivity): DetailActivityView
