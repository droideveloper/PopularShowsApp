...
import org.fs.pshows.util.ImageType

interface ImageBuilder {

  fun createPosterUri(@ImageType imageType: String = IMAGE_TYPE_SMALL, path: String): Uri
  fun createYoutubeUri(path: String): Uri
}