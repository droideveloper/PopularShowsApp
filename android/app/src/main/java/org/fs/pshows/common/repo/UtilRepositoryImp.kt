...
@Singleton
class UtilRepositoryImp @Inject constructor(private val proxy: EndpointProxy): UtilRepository {

  override fun genres(): Observable<Resource<List<Genre>>> = proxy.genres()
}