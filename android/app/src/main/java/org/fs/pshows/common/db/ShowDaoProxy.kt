...
interface ShowDaoProxy {

  fun insert(entity: Show): Completable
  fun update(entity: Show): Completable
  fun delete(entity: Show): Completable
  fun delete(id: Long): Completable

  fun show(id: Long): Observable<Show>
