...
import org.fs.pshows.common.db.util.DbConverters
import org.fs.pshows.model.entity.Show
import org.fs.pshows.util.C.Companion.DB_VERSION

@Database(entities = [Show::class], version = DB_VERSION, exportSchema = false)
