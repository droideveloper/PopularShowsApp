...
class ProviderFragmentModule {
  ...
  @ForFragment @Provides fun provideFeedDataSet(): ObservableList<Show> = ObservableList()
  @ForFragment @Provides fun provideDetailDataSet(): ObservableList<Extra> = ObservableList()
}