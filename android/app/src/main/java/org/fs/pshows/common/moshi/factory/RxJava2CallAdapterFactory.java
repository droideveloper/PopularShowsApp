...
public final class RxJava2CallAdapterFactory extends CallAdapter.Factory {
  ...
  public static RxJava2CallAdapterFactory create(Moshi moshi) {
    return new RxJava2CallAdapterFactory(moshi, null, false);
  }
  ...
  public static RxJava2CallAdapterFactory createWithScheduler(Scheduler scheduler) {
    ...
    return new RxJava2CallAdapterFactory(null, scheduler, false);
  }

  private final @Nullable Moshi moshi;
  private final @Nullable Scheduler scheduler;
  private final boolean isAsync;

  private RxJava2CallAdapterFactory(@Nullable Moshi moshi, @Nullable Scheduler scheduler, boolean isAsync) {
    this.moshi = moshi;
  ...
  @Override public @Nullable CallAdapter<?, ?> get(
    ...
    if (rawType == Completable.class) {
      ...
      return new RxJava2CallAdapter(Void.class, moshi, scheduler, isAsync, false, true, false, false,
          false, true);
    }
    ...
    return new RxJava2CallAdapter(responseType, moshi, scheduler, isAsync, isResult, isBody, isFlowable,
