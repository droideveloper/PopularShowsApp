...
@Singleton
class FeedRepositoryImp @Inject constructor(private val proxy: EndpointProxy): FeedRepository {

  override fun shows(page: Int): Observable<Resource<List<Show>>> = proxy.shows(page)
}